...
return array(
    ...
    'Card form' => 'Card form',
    'Check a payment method to remove it from the form, for instance while it is out of service. The list holds the payment methods activated on your PayZen contract, as the platform reports them.' => 'Check a payment method to remove it from the form, for instance while it is out of service. The list holds the payment methods activated on your PayZen contract, as the platform reports them.',
    ...
    'If this box is checked, the card fields are displayed right away in the SmartForm, the other payment methods being listed below. Otherwise, the customer picks a payment method first.' => 'If this box is checked, the card fields are displayed right away in the SmartForm, the other payment methods being listed below. Otherwise, the customer picks a payment method first.',
    ...
    'Payment methods to switch off' => 'Payment methods to switch off',
    'PayPal' => 'PayPal',
    ...
    'SmartForm, with wallets' => 'SmartForm, with wallets',
